...
Gli accorgimenti per il cubo contentente il telescopio sono gli stessi del progetto del riparo con il tetto a fiore. In questo caso cambierebbe la gestione della meccanica di apertura del tetto. 
\begin{itemize}
