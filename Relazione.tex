...
\begin{figure}
	...
	\begin{subfigure}[b]{0.4\textwidth}
		...
		\caption{Astrofili di tutto il mondo scelgono questa soluzione. Osservatorio di Michele Palma}
	\end{subfigure}
	\qquad\quad
	\begin{subfigure}[b]{0.4\textwidth}
		\centering
		\includegraphics[width=120mm,angle=0,clip=,scale=0.5]{osserv_aperto.jpg}
		\caption{Struttura costruita dal nostro socio Massimo Banfi. Osservatorio Astronomico di Nova Milanese}
	\end{subfigure}
